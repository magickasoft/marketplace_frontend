...
export const LIST_ACTION = 'UI/STORIES_LIST/REVIEW/LIST_ACTION';
...
export const SHOW_DELETE_DIALOG = 'UI/STORIES_LIST/REVIEW/SHOW_DELETE_DIALOG';
...
export const HIDE_DELETE_DIALOG = 'UI/STORIES_LIST/REVIEW/HIDE_DELETE_DIALOG';

export const hideDeleteDialog = () => ({
    type: HIDE_DELETE_DIALOG
});

export const RECEIVE_PAGE_START = 'UI/STORIES_LIST/REVIEW/RECEIVE_PAGE_START';
...
export const RECEIVE_PAGE_FAILURE = 'UI/STORIES_LIST/REVIEW/RECEIVE_PAGE_FAILURE';
...
export const RECEIVE_PAGE_SUCCESS = 'UI/STORIES_LIST/REVIEW/RECEIVE_PAGE_SUCCESS';
...
export const receivePage = curry(
    (current, sort, order) => (dispatch, getState) => {
        ...
        return getStoriesPageRequest(Just(STORY_STATUS_REVIEWED), current, sort, order)
...
export const receivePageAgain = () => (dispatch, getState) => {
    ...
    return ui.storiesList.review.query.cata({
...
export const deleteStory = () => (dispatch, getState) => {
    ...
    return ui.storiesList.review.deleteDialog
        .map(
            bunch => results => ([ bunch, results ])
        ).ap(
            ui.storiesList.review.results
        ).chain(
            ([ bunch, results ]) => find(
...
export const updateStory = curry(
    (bunch, diff) => (dispatch, getState) => {
        ...
        return ui.storiesList.review.results.chain(
                find(
                    compose(isEqual(bunch), property('bunch'))
                )
            ).chain(
